...
#SBATCH --output=/groups/umcg-lifelines/tmp02/projects/ov23_0782/jtuinman/UGLI0-3/scripts/logs/
#SBATCH --error=/groups/umcg-lifelines/tmp02/projects/ov23_0782/jtuinman/UGLI0-3/scripts/logs/
...
mv *.log /groups/umcg-lifelines/tmp02/projects/ov23_0782/jtuinman/UGLI0-3/output/GSA-PLINK/logs/
gzip dataG_DATA_v1.b*
mv dataG_DATA_* /groups/umcg-lifelines/tmp02/projects/ov23_0782/jtuinman/UGLI0-3/output/GSA-PLINK/
